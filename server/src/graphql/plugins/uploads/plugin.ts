function uploadFieldPlugin(
  ...
  builder.hook("build", (_, build) => {
    ...
    const GraphQLUpload = new GraphQLScalarType({
      ...
      parseValue: value => value instanceof Array ? Promise.all(value) : value,
      parseLiteral() {
...
export default function PostGraphileUploadFieldPlugin(builder, options) {
  uploadFieldPlugin(builder, options);
}
